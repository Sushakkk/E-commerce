  ...
  return (
    <main id="main" className="page">
      ...
      <section className={styles.family}>
          ...
          <div className={`${styles['family-body']} ${styles['container-wide']}`}>
